...
export class Perception {
    ...
    /**
     * Clears sensory data of a specific type or all data if no type is provided.
     * @param {string} [type] - The type of sensory input to clear.
     */
    clearSensoryData(type) {
        if (type) {
            delete this.sensoryData[type];
        } else {
            this.sensoryData = {};
        }
    }
