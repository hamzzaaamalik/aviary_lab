...
export class Perception {
   ...
   * @param {Array<any>} data - An array of sensory data inputs.
   * @param {Function} criteria - A function that defines the filtering condition.
   * @returns {Array<any>} - Filtered sensory data.
   * @throws {TypeError} - If the data is not an array or criteria is not a function.
   */
  filterSensoryData(data, criteria) {
    if (!Array.isArray(data)) {
      throw new TypeError('Data must be an array');
    }
