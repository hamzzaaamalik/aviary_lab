...
test('classify throws error for invalid thresholdsMap', () => {
  const inputs = [1, 2, 3];
...
test('classify throws error for non-array inputs', () => {
  assert.throws(() => perception.classify('not an array', { low: 2 }), TypeError);
});
